...
class HomeController extends Controller
{
  ...
  public function create()
  {
    ...
    $tour            = Tour::all();
    $opera           = Operator::all();
    return view('admin/travels.create', compact('viaje', 'deparment', 'rooms', 'currencies', 'airlines', 'countries', 'cities', 'multimedia', 'season', 'section', 'tour', 'opera'));
  }
  ...
  public function edit($id)
  {
    ...
    $airlines        = Airline::all();
    $countries       = Country::all();
    $multimedia      = Multimedia::orderby('type', '=', 'asc')->get();
    $cities          = City::all();
    $season          = Season::all();
    $section         = Section::all();
    $tour            = Tour::all();
